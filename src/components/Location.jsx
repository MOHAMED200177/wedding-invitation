...
function Location() {
  function openMap() {
    window.open(`https://www.google.com/maps?q=${story.lat},${story.lng}`, '_blank')
  }
    ...
    <section style={{ background: '#000', padding: '100px 24px' }}>
      ...
      >
        ...
        <div style={{
          ...
          <p style={{ color: colors.text, fontFamily: 'Georgia, serif', fontSize: '1rem', zIndex: 1 }}>
            {story.venue}
          </p>
        ...
        >
          ...
          <span style={{ color: '#fff', fontFamily: 'Georgia, serif', fontSize: '0.95rem', letterSpacing: '0.1em' }}>
            Open in Google Maps
          </span>
        </motion.button>
      </motion.div>

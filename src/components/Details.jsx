      ...
      <div style={{
        ...
        {details.map((item, i) => (
          ...
          >
            ...
            <div>
              <p style={{ color: colors.gold, fontSize: '0.65rem', letterSpacing: '0.2em', marginBottom: '4px' }}>
                {item.label.toUpperCase()}
              </p>
              <p style={{ color: colors.text, fontFamily: 'Georgia, serif', fontSize: '1rem' }}>
                {item.value}
              </p>
            </div>
          </motion.div>
